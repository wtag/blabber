...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("chat-backend/chat.proto", :syntax => :proto3) do
    ...
    add_message "ChatService.onGetUnseenMessageRequest" do
...
module ChatService
  ...
  OnGetUnseenMessageRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ChatService.onGetUnseenMessageRequest").msgclass
end
