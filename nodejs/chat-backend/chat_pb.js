 ...
 * @constructor
 */
proto.ChatService.RetrieveRoomUsersResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.ChatService.RetrieveRoomUsersResponse.repeatedFields_, null);
};
goog.inherits(proto.ChatService.RetrieveRoomUsersResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ChatService.RetrieveRoomUsersResponse.displayName = 'proto.ChatService.RetrieveRoomUsersResponse';
}
 ...
 * @const
 */
proto.ChatService.RetrieveRoomUsersResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.ChatService.RetrieveRoomUsersResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.ChatService.RetrieveRoomUsersResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.ChatService.RetrieveRoomUsersResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ChatService.RetrieveRoomUsersResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    usersList: jspb.Message.toObjectList(msg.getUsersList(),
    Model_user_pb.User.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.ChatService.RetrieveRoomUsersResponse}
 */
proto.ChatService.RetrieveRoomUsersResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ChatService.RetrieveRoomUsersResponse;
  return proto.ChatService.RetrieveRoomUsersResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ChatService.RetrieveRoomUsersResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ChatService.RetrieveRoomUsersResponse}
 */
proto.ChatService.RetrieveRoomUsersResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ChatService.RetrieveRoomUsersResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ChatService.RetrieveRoomUsersResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ChatService.RetrieveRoomUsersResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ChatService.RetrieveRoomUsersResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUsersList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.Model.User>}
 */
proto.ChatService.RetrieveRoomUsersResponse.prototype.getUsersList = function() {
  return /** @type{!Array<!proto.Model.User>} */ (
...
/**
 * @param {!Array<!proto.Model.User>} value
 * @return {!proto.ChatService.RetrieveRoomUsersResponse} returns this
*/
proto.ChatService.RetrieveRoomUsersResponse.prototype.setUsersList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.Model.User}
 */
proto.ChatService.RetrieveRoomUsersResponse.prototype.addUsers = function(opt_value, opt_index) {
 ...
 * @return {!proto.ChatService.RetrieveRoomUsersResponse} returns this
 */
proto.ChatService.RetrieveRoomUsersResponse.prototype.clearUsersList = function() {
  return this.setUsersList([]);
};
