...
goog.exportSymbol('proto.ChatService.onGetUnseenMessageRequest', null, global);
/**
 ...
 * @constructor
 */
proto.ChatService.onGetUnseenMessageRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.ChatService.onGetUnseenMessageRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ChatService.onGetUnseenMessageRequest.displayName = 'proto.ChatService.onGetUnseenMessageRequest';
}
 ...
 * @return {!Object}
 */
proto.ChatService.onGetUnseenMessageRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.ChatService.onGetUnseenMessageRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.ChatService.onGetUnseenMessageRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ChatService.onGetUnseenMessageRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.ChatService.onGetUnseenMessageRequest}
 */
proto.ChatService.onGetUnseenMessageRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ChatService.onGetUnseenMessageRequest;
  return proto.ChatService.onGetUnseenMessageRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ChatService.onGetUnseenMessageRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ChatService.onGetUnseenMessageRequest}
 */
proto.ChatService.onGetUnseenMessageRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ChatService.onGetUnseenMessageRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ChatService.onGetUnseenMessageRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ChatService.onGetUnseenMessageRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ChatService.onGetUnseenMessageRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getMessageid();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.ChatService.onGetUnseenMessageRequest.prototype.getMessageid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.ChatService.onGetUnseenMessageRequest} returns this
 */
proto.ChatService.onGetUnseenMessageRequest.prototype.setMessageid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.ChatService.onGetUnseenMessageRequest.prototype.getUserid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.ChatService.onGetUnseenMessageRequest} returns this
 */
proto.ChatService.onGetUnseenMessageRequest.prototype.setUserid = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.ChatService.onGetUnseenMessageRequest.prototype.getIscustomer = function() {
 ...
 * @return {!proto.ChatService.onGetUnseenMessageRequest} returns this
 */
proto.ChatService.onGetUnseenMessageRequest.prototype.setIscustomer = function(value) {
